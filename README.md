...
![GitHub repo size](https://img.shields.io/github/repo-size/GuidoAg/clinica?color=blue)
![GitHub language count](https://img.shields.io/github/languages/count/GuidoAg/clinica?color=green)
![GitHub top language](https://img.shields.io/github/languages/top/GuidoAg/clinica?color=red)

</div>

<div align="center">

![Uploa<svg width="800" height="993" viewBox="0 0 800 993" fill="none" xmlns="http://www.w3.org/2000/svg">
...
**[🔗 Clínica - Acceso Web](https://clinica-7117e.web.app/welcome-page)**
...
Los pacientes pueden gestionar sus turnos médicos, consultar su historial y actualizar su información personal de forma sencilla e intuitiva.
...
Los especialistas tienen acceso a herramientas para gestionar sus consultas, revisar historiales clínicos de pacientes y administrar su agenda de atención.

### 📱 Vistas del Especialista
...
Los administradores tienen control total sobre el sistema, pudiendo gestionar usuarios, turnos, y acceder a estadísticas y encuestas del servicio.
...
- 🔐 **Autenticación segura** con múltiples roles de usuario
- 🌍 **Multiidioma** (Español, Inglés, Portugués)
- 📊 **Estadísticas y reportes** en tiempo real
- 🔄 **Actualización en tiempo real** de turnos y disponibilidad
- 📝 **Historias clínicas digitales** completas
- 📈 **Sistema de encuestas** para mejora continua

## 📄 Licencia

Este proyecto fue desarrollado como parte de un trabajo práctico académico.

---

<div align="center">

**Desarrollado con ❤️ para la gestión eficiente de servicios médicos**
